...
public sealed partial class LevelRewardModule(AdminDbContext db) : DiscordApplicationGuildModuleBase
{
    ...
    public partial async Task Add(int tier, int level, string? grantedRoleStr, string? revokedRoleStr)
    {
