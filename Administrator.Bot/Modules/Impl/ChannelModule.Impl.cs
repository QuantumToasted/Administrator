...
public sealed partial class ChannelModule(EmojiService emojiService) : DiscordApplicationGuildModuleBase
{
    public partial IResult DisplayInfo(IChannel channel)
    {
        return Response(FormatChannelInfo(channel));
    }
    
    public sealed partial class ChannelCreateModule : DiscordApplicationGuildModuleBase
    {
    ...
    public partial async Task<IResult> Clone(IChannel channel, string? name = null)
    {
    ...
    public partial async Task<IResult> Modify(IChannel channel)
    {
        IGuildChannel? actualChannel = channel.Type switch
        {
            ChannelType.Forum => Bot.GetChannel(Context.GuildId, channel.Id) as IForumChannel,
    ...
    public partial async Task<IResult> Move(IChannel channelToMove, MoveDirection direction, IChannel targetChannel)
    {
    ...
    public partial async Task Delete(IChannel channel)
    {
    ...
    public partial async Task<IResult> ModifySlowmode(IChannel? channel = null, TimeSpan? duration = null)
    {
