...
[SlashGroup("user")]
public sealed class UserModule(AttachmentService attachments) : DiscordApplicationModuleBase
{
    [SlashCommand("search")]
    ...
    [RequireGuild]
    public async Task<IResult> DisplayServerAvatarAsync(
    ...
    [SlashGroup("xp")]
    public sealed class UserXpModule(ImageService images, AdminDbContext db, EmojiService emojis) : DiscordApplicationModuleBase
    {
        [SlashCommand("stats")]
