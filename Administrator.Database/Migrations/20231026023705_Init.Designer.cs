            ...
            modelBuilder.Entity("Administrator.Database.GlobalUser", b =>
                {
                    ...
                    b.Property<ulong[]>("BlacklistedHighlightChannelIds")
                        .IsRequired()
                        .HasColumnType("numeric(20,0)[]")
                        .HasColumnName("blacklisted_highlight_channels");

                    b.Property<ulong[]>("BlacklistedHighlightUserIds")
                        .IsRequired()
                        .HasColumnType("numeric(20,0)[]")
            ...
            modelBuilder.Entity("Administrator.Database.Guild", b =>
                {
                    ...
                    b.Property<ulong[]>("AutoQuoteExemptChannelIds")
                        .IsRequired()
                        .HasColumnType("numeric(20,0)[]")
                    ...
                    b.Property<ulong[]>("XpExemptChannelIds")
                        .IsRequired()
                        .HasColumnType("numeric(20,0)[]")
            ...
            modelBuilder.Entity("Administrator.Database.RoleLevelReward", b =>
                {
                    ...
                    b.Property<ulong[]>("GrantedRoleIds")
                        .IsRequired()
                        .HasColumnType("numeric(20,0)[]")
                        .HasColumnName("granted_roles");

                    b.Property<ulong[]>("RevokedRoleIds")
                        .IsRequired()
                        .HasColumnType("numeric(20,0)[]")
